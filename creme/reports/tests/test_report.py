...
class ReportTestCase(BaseReportsTestCase):
    ...
    def test_edit_fields02(self):
        ...
        self.assertEqual('{} - {}'.format(_('Maximum'), cf.name), column3.title)
    ...
    def test_edit_fields03(self):
        ...
        self.assertEqual(_('Owner user') + ' - ' + _('Username'), column2.title)
    ...
    def test_fetch_m2m_03(self):
        ...
        self.assertEqual(
            [[self.camp1.name, fmt % (self.ml1.name, self.ptype1.text) + ', ' +
    ...
    def test_fetch_aggregate_04(self):
        ...
        create_cfval = partial(cfield.get_value_class().objects.create, custom_field=cfield)
        ...
        report = self.report_orga
        Field.objects.create(report=report, name='{}__sum'.format(cfield.id), type=RFT_AGG_CUSTOM, order=2)
