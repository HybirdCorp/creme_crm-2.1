...
try:
    ...
    from creme.creme_core.core.job import JobManager, _JobTypeRegistry
...
class JobTypeRegistryTestCase(CremeTestCase):
    def test_register01(self):
        ...
        self.assertEqual(
            logs_manager.output,
            ['CRITICAL:creme.creme_core.core.job:Unknown JobType: {}'.format(TestJobType.id)],
        )
    ...
    def test_register03(self):
        ...
        self.assertEqual('Duplicated job type id: {}'.format(TestJobType1.id),
                         str(cm.exception)
                        )
    ...
    def test_register04(self):
        ...
        self.assertEqual('Empty JobType id: {}'.format(TestJobType),
                         str(cm.exception)
                        )
